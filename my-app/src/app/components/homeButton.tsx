...
const HomeButton = () => {
    ...
    return (
        ...
        //     </span>
        // </div>
        <div onClick={scrollToTop}className="group relative inline-block overflow-hidden rounded border border-gray-100 bg-gray-200  px-12 py-3 text-sm font-medium text-slate-800 hover:bg-gray-300 hover:text-violet-600 focus:outline-none focus:ring active:bg-indigo-600 active:text-white">
